...
public class Pawn {
	...
	//Methode de déplacement, retourne 1 en cas de succes , -1 en cas d'echec
	public int Move(String Direction) {
		
		int result;	//Le retour pour cette méthode
		
		switch(Direction) {
		
		case "Right":
			
			/*On peut se deplacer a droite si on est pas dans la case d'éxtremité droite && qu'il n'y a pas de mur a droite
		...
		case "Left":
			...
			/*On peut se deplacer a gauche si on est pas dans la case d'éxtremité gauche && qu'il n'y a pas de mur a gauche
			 * && qu'il n'y a pas d'autre pion ou on veut se deplacer
			 */
		...
		case "Up":
			...
			/*On peut se deplacer en haut si on est pas dans la case éxtremité d'en haut && qu'il n'y a pas de mur en haut
			 * && qu'il n'y a pas d'autre pion ou on veut se deplacer
			 */
		...
		case "Down":
			...
			/*On peut se deplacer en bas si on est pas dans la case éxtremité d'en bas && qu'il n'y a pas de mur en bas
			 * && qu'il n'y a pas d'autre pion ou on veut se deplacer
			 */
